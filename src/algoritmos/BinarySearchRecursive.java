...
public class BinarySearchRecursive {
    ...
    /** * Java method to perform recursive binary search. It accept an integer array * and a number and return the index of number in the array.
     * If number doesn't * exists in array then it return -1 * * @param input * @param number * @return index of given number in array or -1 if not found */
